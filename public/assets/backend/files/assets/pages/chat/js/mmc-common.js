...
// }
        function messageScroll() {
            setTimeout(function () {
                $('.message-scrooler').each(function () {
                    var messagesContainer = $(this);
                    var newMessage = messagesContainer.find('.messages div:last');
                    ...
                    var contentHeight = messagesContainer[0].scrollHeight;
...
//     var form = $(this).closest('.message-form'); // Find the closest form
...
//             var _box_message = form.closest('.chat-single-box').find('.messages');

//             _box_message.html(response.messagesHtml);
