    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="review-section">
                ...
                <div class="review_box">
                  ...
                  @endif 
                   ...
                   @php
                        ...
                        foreach ($selectedFlightData->offer->paxSegmentList as $segmentData) {
                   ...
                   @endphp    
                   @foreach ($segmentTypes as $mainKey => $mainGroup)
                       
                    <h2 class="d-flex justify-content-between fs-5 px-3 py-2 fs-6 mb-0">

                        <span>
                            <i class="fa-plane text-info fas me-1 fs-6"></i> <text>Destination </text> <text>{{ $mainKey+1 }}</text>
                        </span>
                        <span class="small">{{ count($mainGroup) }} Flights</span>
                    </h2>
                    @foreach ($mainGroup as $segmentKey => $mainSegment)
                    @php
                        $mainSegment=$mainSegment->paxSegment;
                    @endphp
                            ...
                            <div class="row row d-flex align-items-center">
                                <div
                                    ...
                                    <div class="airlines-details text-center">
                                        ...
                                        <img src="{{ asset('assets/frontend/images/airlines/'.$mainSegment->marketingCarrierInfo->carrierDesigCode) }}.png"
                                            class="img-fluid blur-up airlines-icon lazyloaded" alt="EY">
                                        <p>{{ $mainSegment->marketingCarrierInfo->carrierName }}</p>
                                        <span>{{ $mainSegment->marketingCarrierInfo->carrierDesigCode }}-{{ $mainSegment->marketingCarrierInfo->marketingCarrierFlightNumber }}</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="row d-flex align-items-center">
                                        <div class="col-4">
                                            <div class="flight-info">
                                                <h5 class="flight-time">{{ formatTime($mainSegment->departure->aircraftScheduledDateTime) }}</h5>
                                                <p class="flight-date">{{ formatTime($mainSegment->departure->aircraftScheduledDateTime,'M d, Y') }}</p>
                                                <h4 class="dept-airport" title="Singapore Changi Airport,">
                                                    {{ $mainSegment->departure->iatA_LocationCode }}
                                                </h4>
                                        ...
                                        <div class="col-4 text-center">
                                            <div class="interval-dots">
                                                <div class="dots">
                                                    <svg class="svg1" width="9" height="10" viewBox="0 0 9 10"
                                                        fill="#ffc610" xmlns="http://www.w3.org/2000/svg">
                                                        <circle cx="4.35644" cy="4.72949" r="4.35644"
                                                            fill="#ffc610"></circle>
                                                    </svg>
                                                    <svg class="svg2" width="21" height="20"
                                                        ...
                                                        <path
                                                            ...
                                                            fill="black" fill-opacity="0.7"></path>
                                                    </svg>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="flight-info">
                                                <h5 class="flight-time">{{ formatTime($mainSegment->arrival->aircraftScheduledDateTime) }}</h5>
                                                <p class="flight-date">{{ formatTime($mainSegment->arrival->aircraftScheduledDateTime,'M d, Y') }}</p>
                                                <h4 class="dept-airport" title="AUH">
                                                    {{ $mainSegment->arrival->iatA_LocationCode }}
                                                </h4>
                    ...
                    <div class="col-sm-12 text-center details-result">

                        <div class="connectiondetail my-0">
                            <p>
                                Interval: {{ formatMinutes($mainSegment->duration) }}
                            </p>
                        </div>
                    </div>
                    @endforeach
              ...
              <form action="{{ route('/flight-form') }}" method="POST">
                @csrf
                <div class="review_box">
                  @php
                      $searchSession=session('searchParams');
                      $adult=$searchSession['adult'];
                      $child=$searchSession['child'];
                      $infant=$searchSession['infant'];
                      $travelers = [];
                    ...
                    for ($i = 0; $i < $child; $i++) {
                        $travelers[] = ['type' => 'CHILD'];
                    }

                    for ($i = 0; $i < $infant; $i++) {
                        $travelers[] = ['type' => 'INFANT'];
                    }
                  @endphp
                  @foreach ($travelers as $tKey => $traveler)
                      
                    <div class="title-top">
                        <h5><i class="fa-solid fa-users text-info me-2"></i>Traveller - {{ $tKey+1 }} - {{ ucfirst($traveler['type']) }} </h5>
                    </div>

                    <div class="flight_detail">
                        <input type="hidden" name="passType[]" value="{{ $traveler['type'] }}">
                        <div class="row" id="passengers-toggle-0">
                            <div class="col-md-4 mb-3">
                                <div class="form-group form-floating mb-0">
                                    <select id="title-{{ $tKey }}" class="select2 form-select"
                                        name="title[]"
                                        data-val-required="{{ $traveler['type'] }}-{{ $tKey }} title is required." data-val="true"
                                    ...
                                    <label for="title-{{ $tKey }}" class="required">Choose Title</label>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group form-floating mb-0">
                                    ...
                                    <input id="fname-{{ $tKey }}" class="form-control pl-3" type="text"
                                        name="first_name[]" placeholder="Enter First Name"
                                        data-val-required="{{ $traveler['type'] }}-{{ $tKey }} first name is required."
                                        ...
                                        value="{{ old('first_name.' . $tKey) }}">
                                    <label for="fname-{{ $tKey }}">First Name</label>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group form-floating mb-0">
                                    <span class="fa-regular text-muted fa-user"></span>
                                    <input id="lname-{{ $tKey }}" class="form-control" type="text"
                                        name="last_name[]" placeholder="Last Name"
                                        data-val-required="{{ $traveler['type'] }}-{{ $tKey }} last name is required" data-val-maxlength-max="50"
                                        data-val-maxlength="{{ $traveler['type'] }}-{{ $tKey }} Cannot be more than 50 characters"
                                        data-val-regex-pattern="^[0-9a-zA-Z''-'\s]{1,40}$"
                                        data-val-regex="{{ $traveler['type'] }}-1 Special characters are not allowed" data-val="true" autocomplete="off" required
                                        value="{{ old('last_name.' . $tKey) }}">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group form-floating mb-0">
                                    <span class="fa-regular text-muted fa-calendar"></span>
                                  

                                    <input id="dob-{{ $tKey }}" value="" name="dob[]" data-next=""
                                        readonly="readonly"
                                        type="text" autocomplete="false" placeholder="Date of Birth"
                                        data-val-required="{{ $traveler['type'] }}-{{ $tKey }} DOB date required" data-val="true"
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group form-floating mb-0">
                                    <select id="gender-{{ $tKey }}" class="select2 form-select"
                                        name="gender[]"
                                        data-val-required="{{ $traveler['type'] }}-{{ $tKey }} gender is required." data-val="true"
                                         aria-hidden="true" required>
                                    ...
                                    <label for="gender-{{ $tKey }}" class="required">Select Gender</label>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group form-floating mb-0">
                                    <span class="fa-regular text-muted fa-user"></span>
                                    <input id="pidno-{{ $tKey }}" class="form-control" type="text"
                                        name="pidno[]" placeholder="P4366918"
                                        data-val-required="{{ $traveler['type'] }}-{{ $tKey }} Passport No is required" data-val-maxlength-max="50"
                                        data-val-maxlength="{{ $traveler['type'] }}-{{ $tKey }} Cannot be more than 50 characters"
                                        data-val-regex-pattern="^[0-9a-zA-Z''-'\s]{1,40}$"
                                        data-val-regex="{{ $traveler['type'] }}-{{ $tKey }} Special characters are not allowed" data-val="true" autocomplete="off" required  value="{{ old('pidno.' . $tKey) }}">
                                    <label class="label-text">Passport No</label>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group form-floating mb-0">
                                    <select id="ncc-{{ $tKey }}" class="form-select select2 "
                                        name="country[]"
                                        data-val-required="{{ $traveler['type'] }}-{{ $tKey }} nationality is required" data-val="true"
                                        >
                                    ...
                                    <label class="label-text">Passport Issuing Country</label>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group form-floating mb-0">
                                    ...
                                    <input id="ped-{{ $tKey }}" value="Sep 04, 2024" name="pied[]"
                                        data-start="Mar 04, 2024" data-end="Mar 04, 2034" readonly="readonly"
                                        type="text" autocomplete="false" placeholder="Passport Expiry"
                                        data-val-required="{{ $traveler['type'] }}-{{ $tKey }} Expiry date required" data-val="true"
                                        class="form-control date-input"  value="{{ old('pied.' . $tKey) }}">
                ...
                <div class="continue-btn text-center mb-2">
                    ...
                    <button type="submit" class="button ladda-button m-auto has-spinner" data-style="slide-left"><span class="button-text">Proceed to Booking</span></button>
                </div>
            </form>
            </div>
        </div>
