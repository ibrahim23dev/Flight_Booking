                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        <h4>Manage Blog-Update </h4>
                                        <span>You can blog update from here</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="">Blog-Update</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="home7" role="tabpanel">
                                        ...
                                        <form action="{{ route('blogs.update',$blog->id) }}" method="post" id="mainFormHtml" enctype="multipart/form-data">
                                            @csrf
                                           @method('PATCH')
                                            ...
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-sm-6">
                                                  ...
                                                  <option value="tour" {{ ($blog->category='tour')?'selected':'' }}>Tour</option>
                                            ...
                                            <div class="col-sm-12">
                                              ...
                                              <div class="input-group">
                                                  ...
                                                  <input type="text" class="form-control" placeholder="Blog Title" name="title" value="{{old('title',$blog->title)}}">
                                              </div>
                                            ...
                                            <div class=" row col-12">
                                              ...
                                              <textarea rows="5" cols="5" class="form-control" placeholder="Blog Description" name="description">{{ $blog->description }}</textarea>
                                              <x-input-error :messages="$errors->get('description')" class="mt-2" />
                                          </div>
                                          <div class=" row col-12">
                                            <label for="">Content</label>
                                            <textarea rows="5" cols="5" class="form-control"  name="content" id="editor">{{ $blog->content }}</textarea>
