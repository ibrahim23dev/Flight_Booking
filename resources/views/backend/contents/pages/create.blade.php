                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        <h4>Manage Page-Create </h4>
                                        <span>You create page from here</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="">Page-Create</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="home7" role="tabpanel">
                                        ...
                                        <form action="{{ route('pages.store') }}" method="post" id="mainFormHtml" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Page Title" name="title" value="{{old('title')}}">
                                                    </div>
