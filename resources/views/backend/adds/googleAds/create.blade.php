...
@section('title', 'Google-Advertisements-create')
                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        <h4>Create Google Advertisements</h4>
                                        <span>You can create new google advertisement from here</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="home7" role="tabpanel">
                                        <form class="md-float-material card-block" action="{{route('google-ads.store')}}" method="post" enctype="multipart/form-data">
                                          @method('POST')
                                          @csrf
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Code of Ad" name="ad_code" value="{{old('ad_code')}}">
                                                    </div>
