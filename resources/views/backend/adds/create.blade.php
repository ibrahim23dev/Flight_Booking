...
@section('title', 'Advertisements-create')
                            ...
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        ...
                                        <span>You can create new advertisement from here</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="home7" role="tabpanel">
                                        <form class="md-float-material card-block" action="{{route('advertisements.store')}}" method="post" enctype="multipart/form-data">
                                          @method('POST')
                                          @csrf
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Name of Ad" name="name" value="{{old('name')}}">
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="icofont icofont-ui-user"></i></span>
                                                        <input type="text" class="form-control"
                                                            placeholder="Link to ad" name="link">
                                                    </div>
