...
@section('title', 'Cpnael-Account-Success')
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="product-edit">
                                                    ...
                                                    <h5 class="text-success">{{ $message }} <span>Please read this page carefully below mentioned details for your account.</span></h5>
