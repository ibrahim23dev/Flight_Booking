                      ...
                      <div class="col-lg-4">
                          <div class="page-header-breadcrumb">
                              <ul class="breadcrumb-title">
                                  ...
                                  <li class="breadcrumb-item"><a href="#!">Tenants</a>
                                  </li>
                  ...
                  <div class="page-body">
                    ...
                    <div class="card">
                      <div class="card-header">
                          <h5 class="card-header-text">Tenants</h5>
                          <a href="{{route('tenants.create')}}" class="btn btn-primary adn-50 adn-right float-right">
