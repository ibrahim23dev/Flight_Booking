...
@section('title', 'Custom-fees-create')
                            ...
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        ...
                                        <span>You can create custome fees from here</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="tab-content">
                                    ...
                                    <form action="{{route('custom-fees.store')}}" method="post" enctype="multipart/form-data">
                                          @csrf
                                            ...
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Price to add or total" name="price" value="{{old('price')}}">
                                                    </div>
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Iata Code of airline" name="iata_code" value="{{old('iata_code')}}">
                                                    </div>
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="icofont icofont-lock"></i></span>
                                                        <input type="text" class="form-control"
                                                            placeholder="Icao Code of airline" name="icao_code" value="{{old('icao_code')}}">
                                                    </div>
