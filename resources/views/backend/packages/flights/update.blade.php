                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        <h4>Update flight Package</h4>
                                        <span>You can update flight package from here</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="">Update flight package</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="tab-content">
                                    ...
                                    <form action="{{route('flight-packages.update',$flight->flight_id)}}" method="post" enctype="multipart/form-data">
                                          @csrf
                                            @method('PATCH')
                                            <div class="row mt-2">
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Airline Or Airport Name" name="airline" value="{{old('airline',$flight->airline)}}">
                                                    </div>
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="icofont icofont-ui-user"></i></span>
                                                        <input type="text" class="form-control"
                                                            placeholder="Arrival City" name="arrival_city" value="{{old('arrival_city',$flight->arrival_city)}}">
                                                    </div>
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Package Price" name="price" value="{{old('price',$flight->price)}}">
                                                    </div>
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="fa fa-dollar"></i></span>
                                                        <input type="text" class="form-control"
                                                            placeholder="Currency" name="currency" value="{{old('currency',$flight->currency)}}">
                                                    </div>
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="icofont icofont-ui-user"></i></span>
                                                        <input type="text" class="form-control"
                                                            placeholder="Arrival IataCode" name="arrival_iataCode" value="{{old('arrival_iataCode',$flight->arrival_iataCode)}}">
                                                    </div>
