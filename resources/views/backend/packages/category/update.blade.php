                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        <h4>Update Package Category</h4>
                                        <span>You can update package from here</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="tab-content">
                                    ...
                                    <form action="{{route('categories.update',$package->id)}}" method="post" enctype="multipart/form-data">
                                          @csrf
                                          @method('PATCH')
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Package Location" name="location" value="{{old('location',$package->location)}}">
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="icofont icofont-ui-user"></i></span>
                                                        <input type="text" class="form-control"
                                                            placeholder="Package Name" name="package_category_name" value="{{old('package_category_name',$package->package_category_name)}}">
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="icofont icofont-ui-user"></i></span>
                                                        <input type="text" class="form-control"
                                                            placeholder="Package Description" name="description" value="{{old('description',$package->description)}}">
                                                    </div>
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Package Price" name="starting_price" value="{{old('starting_price',$package->starting_price)}}">
                                                    </div>
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="fa fa-dollar"></i></span>
                                                        <input type="text" class="form-control"
                                                            placeholder="Currency Code" name="currency" value="{{old('currency',$package->currency)}}">
                                                    </div>
