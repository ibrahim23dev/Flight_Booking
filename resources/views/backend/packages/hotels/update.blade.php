                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        <h4>Update Hotel Package</h4>
                                        <span>You can update hotel package from here</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="">Update hotel package</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="tab-content">
                                    ...
                                    <form action="{{route('hotel-packages.update',$hotel->hotel_id)}}" method="post" enctype="multipart/form-data">
                                          @csrf
                                        @method('PATCH')
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="wall-img-preview lightgallery-popup">
                                                ...
                                                <div class="col-md-2 p-0 wall-item" data-src="{{ Storage::url($image) }}">
                                                    ...
                                                    <a href="{{ route("hotel-packages.delete-image", ['hotel' => $hotel->hotel_id, 'index' => $key]) }}" class="delete-link text-danger" >
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Hotel Name" name="name" value="{{old('name',$hotel->name)}}">
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Package Price" name="price_per_night" value="{{old('price_per_night',$hotel->price_per_night)}}">
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="icofont icofont-ui-user"></i></span>
                                                        <input type="text" class="form-control"
                                                            placeholder="No of Rooms" name="num_rooms" value="{{old('num_rooms',$hotel->num_rooms)}}">
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Location" name="location" value="{{old('location',$hotel->location)}}">
                                                    </div>
